...
import { changePassword,changeFullNameOrPassword, currentUser,changeCoverImageOrAvatar,userChannelProfile,watchHistory,uploadVideo} from "../controllers/user.controllers.js";
const router=Router()
